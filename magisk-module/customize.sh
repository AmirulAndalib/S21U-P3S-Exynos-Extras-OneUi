...
print_modname() {
  ui_print "*************************************************************************************************************"
  ui_print "      CSC Feature Files with some extras for Samsung Galaxy S21/S21+/S21 Ultra Exynos devices        "
  ui_print "*************************************************************************************************************"
}
...
set_permissions() {
  ...
  set_perm_recursive  $MODPATH/cameradata/camera_feature.xml       0       0       0755            0644
